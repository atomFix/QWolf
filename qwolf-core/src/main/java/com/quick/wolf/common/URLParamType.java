...
public enum URLParamType {
     ...
     * version
     **/
    version("version", WolfConstants.DEFAULT_VERSION),
    /**
     * request timeout
     **/
     ...
     * endpointFactory
     **/
    endpointFactory("endpointFactory", "wolf"),
    /**
     * heartbeatFactory
     **/
    heartbeatFactory("heartbeatFactory", "wolf"),
    /**
     * switcherService
     **/
    ...
    application("application", WolfConstants.APPLICATION_NAME),
    ...
    registryRetryPeriod("registryRetryPeriod", 30 * WolfConstants.SECOND_MILLS),
    /* 注册中心不可用节点剔除方式 */
    ...
    check("check", "true"),
    directUrl("directUrl", ""),
    registrySessionTimeout("registrySessionTimeout", WolfConstants.MINUTE_MILLS),
